---
title: "11.5_snRNAseq_cluster_stats_optional_subset_clusters_v3"
...
start_data <- "QCd_louvain_multi_clustered_15pcs_ws_subsetSCT_20210331.rdata" 
...
# If you are subsetting by CLUSTERS:
  ...
  clust_subset_names <- c("0", "2", "3", "5", "6", "8", "9", "11", "13",
                          "15", "22")
...
if (sample_sub) {
  ...
  rm(overall, prop_overall, subset_table, sample_table,
     ...
     total_tables, subset_type, change_output_path)
