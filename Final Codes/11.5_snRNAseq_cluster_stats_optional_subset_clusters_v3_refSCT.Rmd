---
title: "11.5_snRNAseq_cluster_stats_optional_subset_clusters_v3_refSCT"
...
start_data <- "QCd_leiden_clustered_ws_20pcs_APOE33.rdata" 

# Resolution chosen from previous clustering to use to label clusters:
change_resolution <- "0.25"
...
meta_vars <- c("Study_Designation", "APOE", "Sex", "SeqBatch", "NP_Dx",
...
# Do you want to save clustering information for the current dataset in your new
# subset metadata?
save_clusters <- FALSE

# Provide a prefix to name the clustering information in your new metadata
# variables. (ensure you have an _ on the end of your prefix)
clusters_prefix <- NULL
...
# If you are subsetting by CLUSTERS:
  ...
  clust_subset_names <- NULL #c("0", "2", "3", "5", "6", "8", "9", "11", "13",
                          #"15", "22")
...
if (sample_sub) {
  #Remove extra data
  rm(overall, prop_overall, subset_table, sample_table,
