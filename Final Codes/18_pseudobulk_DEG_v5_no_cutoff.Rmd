---
title: "18_pseudobulk_DEG_v5_no_cutoff"
...
bulk_path <- change_path(paste0(outpath, "/DEG/pseudobulk_by_group/no_cutoff/redo/"))
...
for (cluster in clusters) {
  ...
  bulk_path <- paste0(outpath, "/DEG/pseudobulk_by_group/no_cutoff/redo/")
  ...
  for (effect in names) {
    ...
    if (identical(method, "lfc") & dim(filter(results, padj < 0.05))[1] > 0) {
      ...
      bulk_path <- change_path(paste0(outpath,
                                      "/DEG/pseudobulk_by_group/no_cutoff/redo/lfc_GSEA/"))
      plots_path <- change_path(paste0(bulk_path, "plots/"))
      ...
      # Change output folders
      bulk_path <- change_path(paste0(outpath,
                                      "/DEG/pseudobulk_by_group/no_cutoff/redo/log10p_GSEA/"))
      plots_path <- change_path(paste0(bulk_path, "plots/"))
      ...
      # Change output folders
      bulk_path <- change_path(paste0(outpath,
                                      "/DEG/pseudobulk_by_group/no_cutoff/redo/Wald/"))
      plots_path <- change_path(paste0(bulk_path, "plots/"))
