...
change_suffix <- NULL #"_post-sub_no_7"
...
#DefaultAssay(ss_data_norm) <- "SCT"  ## Not sure why this was hardcoded
...
ss_data_norm <- FindClusters(ss_data_norm,
                  resolution = res,
                  algorithm = 2) #,
                  #graph.name = "SCT_snn") # 2 = Louvain algorithm with multilevel
                                        #     refinement
...
save.image(file = paste0(rfiles_path, "QCd_louvain_multi_clustered_ws_", nPCs,
