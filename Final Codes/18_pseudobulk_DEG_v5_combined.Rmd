...
start_data <- "QCd_leiden_clustered_ws_20pcs_no-ref_no_s6868.rdata"
...
# Remove lowly expressed genes which have less than 20% of cells with any counts
...
for (meta_var in 1:length(meta_vars)) {
