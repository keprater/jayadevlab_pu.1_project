...
meta_vars <- c("Study_Designation", "Sex", "Age")
...
interactions <- NULL #c("Study_Designation:Age")
...
for (cluster in clusters) {
  ...
  for (effect in names) {
    ...
    if (dim(sig_markers)[1] > 0) {
      ...
      top_genes <- top_n(sig_markers, n = n, wt = padj)[,c(2,4)] %>%
