...
ggsave(filename = paste0(umaps_path,"/", cell_type, "_density_umap_", chose_resolution, suffix, ".png"), height = 7, width = 11, plot = plot3)
```

## Save the data files.
```{r Save_Files}
rm(plot1, plot2, color_list, plot3, resolutions, umap_pngs)
#Save workspace image if needed to revisit
save.image(file = paste0("QCd_norm_anchored_clustered_wscale_ws", suffix, ".rdata"), compress = TRUE)
